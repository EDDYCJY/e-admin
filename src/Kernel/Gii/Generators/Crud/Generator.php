...
namespace Eadmin\Kernel\Gii\Generators\Crud;
 ...
 * @since 2.0
 */
class Generator extends \common\eadmin\kernel\gii\Generator
{
    public $modelClass;
        ...
        if ($column->phpType === 'boolean') {
            ...
            if (is_array($column->enumValues) && count($column->enumValues) > 0) {
                ...
                if(! empty($htmlOptions)) {
                    return "\$form->field(\$model, '$attribute')->$input([$htmlOptions])";
                }
